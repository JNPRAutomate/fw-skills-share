#!/usr/bin/env bash
#
# install.sh - Installer for JNPRAutomate/fw-skills-share Claude Code / Codex / Hermes skills
#
# Usage: ./install.sh [options]
#   OR:  curl -fsSL https://raw.githubusercontent.com/JNPRAutomate/fw-skills-share/main/install.sh | bash
#
# Options:
...
# Constants
GITHUB_REPO="JNPRAutomate/fw-skills-share"
GITHUB_BRANCH="main"
...
Examples:
  ...
  curl -fsSL https://raw.githubusercontent.com/JNPRAutomate/fw-skills-share/main/install.sh | bash -s -- --all -y
EOF
}
